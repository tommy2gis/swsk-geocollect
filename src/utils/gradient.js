/*
 * @Author: 史涛 
 * @Date: 2019-01-05 19:31:50 
 * @Last Modified by:   史涛 
 * @Last Modified time: 2019-01-05 19:31:50 
 */
import Color from 'color'
 const NO_EDN_FRAC = new Error('The last element in the color array should not have a frac field')
 const MIN_ARRAY_LENGTH = new Error('Color array length must > 1')
 const FRAC_SUM_ERROR = new Error('The sum of the fracs should = 1')
 const COLOR_NUMBER_ERROR = new Error('The number of generated colors should >= the number of color stops')
